...
export const GETEXPLOREEVENTS_EP = 'http://' + HOST + ':8080/api/v1/getExploreEvents';
export const LOGIN_EP = 'http://' + HOST + ':8080/api/v1/login';
export const CHECKPASSWORD_EP = 'http://' + HOST + ':8080/api/v1/checkPw';
export const REGISTER_EP = 'http://' + HOST + ':8080/api/v1/register';
