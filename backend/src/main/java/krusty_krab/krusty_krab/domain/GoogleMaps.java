...
public class GoogleMaps {
    ...
    public List<Event> getEvents(Time startTime, Time endTime, String curLoc, String location, float maxDist, List<String> activities, float budget){
        ...
        Event e2 = new Event("cn tower", "cn tower", "lookout", 4, 40, new Time(2019, 10, 25, 8, 0, true), new Time(2019, 10, 25, 22, 0, true), new Time(0, 0, 0, 2, 0, true),"toronto", "If Quebec is Canada's ass...");
        Event e3 = new Event("Canadian National Exhibition", "Canadian National Exhibition", "Festival", 4, 40, new Time(2019, 10, 25, 8, 0, true), new Time(2019, 10, 25, 22, 0, true), new Time(0, 0, 0, 2, 0, true),"toronto", "If Quebec is Canada's ass...");
        Event e4 = new Event("Eaton Centre", "Eaton Centre", "Mall", 4, 40, new Time(2019, 10, 25, 8, 0, true), new Time(2019, 10, 25, 22, 0, true), new Time(0, 0, 0, 2, 0, true),"toronto", "If Quebec is Canada's ass...");
